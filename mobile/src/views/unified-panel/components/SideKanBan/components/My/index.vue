        ...
        <div
          ...
          <DropDownItemSelection
            v-if="
              ...
              (child.authority > 1 && authEnum.addDash)
            "
            :offset="offset"
            placement="right">
            <span class="nd-more-icon" @click.stop>
            ...
            <template #content>
              ...
              <el-dropdown-item
                v-if="child.authority > 1 && authEnum.addDash"
                @click="handleCopy(child)">
                {{ t('btn.copy') }}
              </el-dropdown-item>
              <el-dropdown-item
...
import { authEnum } from '@/views/unified-panel/enum'
...
import useMoveEvent from '@/views/see-plate/useMoveEvent.js'
