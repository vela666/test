...
import CustomWeek from '@/views/analysis/scatter/analysis-main/CustomWeek.vue'
import CustomTable from '@/views/analysis/scatter/analysis-main/CustomTable.vue'
import useDashboardScatter from '@/views/analysis/scatter/hooks/useDashboardScatter.js'
...
const {
  ...
  cancelRequest,
  getSetting,
} = useDashboardScatter(props, emits)
