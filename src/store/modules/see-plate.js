...
import {
  ...
  asyncGetKanBanReportList,
  asyncGetShareMemberList,
} from '@/api/modules/see-plate/dashboard'
import { asyncGetKanBanNoteList } from '@/api/modules/see-plate/note'
...
export default defineStore('seePlate', () => {
  ...
  const getLeftKanBanInfo = async () => {
    ...
    state.navigationExpand = data.navigationExpand
  }
  // getLeftKanBanInfo()
